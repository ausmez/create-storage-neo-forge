...
public class SimpleStorageBoxScenes {
    ...
    public static void intro(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlock(b1, s -> ModBlocks.SIMPLE_STORAGE_BOX_BIRCH.getDefaultState()
        ...
        scene.world().modifyBlock(b2, (s) -> ModBlocks.SIMPLE_STORAGE_BOX_DARK_OAK.getDefaultState()
                .setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
        ...
        scene.world().modifyBlock(b3, (s) -> ModBlocks.SIMPLE_STORAGE_BOX_WARPED.getDefaultState()
                .setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
    ...
    public static void interact(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlock(sSBox, (s) -> ModBlocks.SIMPLE_STORAGE_BOX.getDefaultState()
    ...
    public static void upgrades(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(40);
        scene.world().modifyBlock(leftBox, (s) -> ModBlocks.SIMPLE_STORAGE_BOX.get().defaultBlockState()
                .setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
