...
public class SimpleStorageBoxScenes {
    ...
    public static void intro(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.modifyBlock(b1, (s) -> ModPonder.SIMPLE_STORAGE_BOX_BIRCH.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
        ...
        scene.world.modifyBlock(b2, (s) -> ModPonder.SIMPLE_STORAGE_BOX_DARK_OAK.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
        ...
        scene.world.modifyBlock(b3, (s) -> ModPonder.SIMPLE_STORAGE_BOX_WARPED.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
    ...
    public static void interact(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(sSBox, Direction.NORTH), Pointing.RIGHT)).rightClick().withItem(gold), 80);
        ...
        scene.world.modifyBlock(sSBox, (s) -> ModPonder.SIMPLE_STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.HAS_ITEMS), false);
        scene.idle(80);
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(sSBox, Direction.NORTH), Pointing.RIGHT)).leftClick(), 50);
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(sSBox, Direction.NORTH), Pointing.RIGHT)).leftClick().whileSneaking(), 50);
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(sSBox, Direction.NORTH), Pointing.RIGHT)).rightClick().whileSneaking(), 60);
    ...
    public static void upgrades(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(leftBox, Direction.NORTH), Pointing.RIGHT)).rightClick().withItem(vUpgrade), 30);
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(rightBox, Direction.NORTH), Pointing.RIGHT)).rightClick().withItem(cUpgrade), 30);
