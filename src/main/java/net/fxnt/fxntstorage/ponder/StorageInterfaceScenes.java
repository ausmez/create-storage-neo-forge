...
public class StorageInterfaceScenes {
    ...
    public static void intro(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(15);
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(iface, Direction.NORTH), Pointing.RIGHT)).showing(AllIcons.I_MTD_CLOSE).withItem(emerald), 25);
        scene.idle(75);
