...
public class SmartPasserBlockScenes {
    public static void intro(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.addKeyframe();
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(srcBox.north(), Direction.NORTH), Pointing.RIGHT)).withItem(sand), 20);
        scene.world.modifyBlock(srcBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.HAS_ITEMS), false);
        scene.idle(30);
        ...
        scene.world.modifyBlock(dstBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.HAS_ITEMS), false);
        scene.idle(20);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (i < 2) scene.idle(20); else scene.idle(10);
        }
        scene.idle(35);

        scene.addKeyframe();
        scene.overlay.showControls((new InputWindowElement(filter.add(0.35, 0.15, 0), Pointing.DOWN)).rightClick().withItem(gunpowder), 20);
        scene.idle(7);
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (i == 0) scene.idle(20); else scene.idle(10);
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 3) scene.world.modifyBlock(srcBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.EMPTY), false);
            scene.idle(20);
        }
