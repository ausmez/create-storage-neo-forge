...
public class StorageBoxScenes {
    ...
    public static void interact(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(util.vector().blockSurface(dstStorageBox, Direction.NORTH).add(0, 0.15, 0), Pointing.RIGHT, 30).rightClick().withItem(new ItemStack(AllItems.WRENCH));
