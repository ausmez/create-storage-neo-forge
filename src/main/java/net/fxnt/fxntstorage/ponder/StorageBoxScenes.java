...
import net.fxnt.fxntstorage.init.ModPonder;
...
public class StorageBoxScenes {
    ...
    public static void interact(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(srcStorageBox, Direction.NORTH).add(0, 0.15, 0), Pointing.DOWN)).rightClick().withItem(sand), 30);
        ...
        scene.world.modifyBlock(srcStorageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.HAS_ITEMS), false);
        scene.idle(70);

        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(srcStorageBox, Direction.NORTH).add(0, 0.15, 0), Pointing.DOWN)).rightClick().whileSneaking(), 30);
        ...
        for (int i = 0; i < 14; ++i) {
            ...
            switch (i) {
                case 2:
                    scene.world.modifyBlock(dstStorageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.HAS_ITEMS), false);
                ...
                case 7:
                    ...
                    scene.world.modifyBlock(dstStorageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.SLOTS_FILLED), false);
                ...
                case 13:
                    ...
                    scene.world.modifyBlock(dstStorageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.FULL), false);
                    scene.world.modifyBlockEntity(dstStorageBox, StorageBoxEntity.class, (t) -> {
                        for (int j = 0; j < t.getContainerSize(); j++) {
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(dstStorageBox, Direction.NORTH).add(0, 0.15, 0), Pointing.RIGHT)).rightClick().withItem(new ItemStack(AllItems.WRENCH)), 30);
        ...
        scene.world.modifyBlock(dstStorageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(VOID_UPGRADE, true), false);
        scene.idle(70);
        ...
        scene.world.modifyBlock(srcStorageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.EMPTY), false);
        scene.idle(4);
        scene.world.removeItemsFromBelt(util.grid.at(1, 1, 2));
        scene.idle(90);
    ...
    public static void filter(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls((new InputWindowElement(filter, Pointing.DOWN)).rightClick().withItem(diamond), 30);
        scene.idle(20);
        ...
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(storageBox, Direction.NORTH).add(0, -0.2, 0), Pointing.RIGHT)).showing(AllIcons.I_MTD_CLOSE).withItem(coal), 30);
        scene.idle(60);
        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(storageBox, Direction.NORTH).add(0, -0.2, 0), Pointing.RIGHT)).showing(AllIcons.I_CONFIRM).withItem(diamond), 30);
        scene.world.modifyBlock(storageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.HAS_ITEMS), false);
        scene.world.modifyBlockEntity(storageBox, StorageBoxEntity.class, (t) -> t.getItemHandler().setStackInSlot(0, diamond));
        scene.idle(60);

        scene.overlay.showControls((new InputWindowElement(util.vector.blockSurface(storageBox, Direction.NORTH).add(0, -0.2, 0), Pointing.RIGHT)).showing(AllIcons.I_RMB).withItem(brassHand), 90);
        scene.idle(10);
        ...
        scene.world.modifyBlock(storageBox, (s) -> ModPonder.STORAGE_BOX.getDefaultState().setValue(STORAGE_USED, EnumProperties.StorageUsed.EMPTY), false);
