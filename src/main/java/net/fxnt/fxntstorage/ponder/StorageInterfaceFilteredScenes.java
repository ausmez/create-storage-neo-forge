...
public class StorageInterfaceFilteredScenes {
    ...
    public static void intro(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(50);
        for (int i = 0; i < 4; i++) {
            extractOne(scene, boxes.getFirst().pos);
            scene.idle(10);
        }
    ...
    public static void filter(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntityNBT(nixie, NixieTubeBlockEntity.class, nbt -> {
            ...
            nbt.putString("CustomText", Component.Serializer.toJson(seven, scene.world().getHolderLookupProvider()));
        });
        ...
        scene.world().modifyBlockEntityNBT(nixie, NixieTubeBlockEntity.class, nbt -> {
            ...
            nbt.putString("CustomText", Component.Serializer.toJson(four, scene.world().getHolderLookupProvider()));
        });
        ...
        scene.world().modifyBlockEntityNBT(nixie, NixieTubeBlockEntity.class, nbt -> {
            ...
            nbt.putString("CustomText", Component.Serializer.toJson(nine, scene.world().getHolderLookupProvider()));
        });
