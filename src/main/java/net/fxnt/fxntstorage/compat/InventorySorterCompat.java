...
import net.fxnt.fxntstorage.backpacks.main.ToolSlot;
import net.fxnt.fxntstorage.backpacks.main.UpgradeSlot;
...
public class InventorySorterCompat {
    ...
    public static void sendIMC() {
        ...
        InterModComms.sendTo(ModCompats.INVENTORY_SORTER, CONTAINER_BLACKLIST, () -> ForgeRegistries.MENU_TYPES.getKey(ModMenuTypes.BACK_PACK_BLOCK_MENU.get()));
        InterModComms.sendTo(ModCompats.INVENTORY_SORTER, CONTAINER_BLACKLIST, () -> ForgeRegistries.MENU_TYPES.getKey(ModMenuTypes.BACK_PACK_ITEM_MENU.get()));
