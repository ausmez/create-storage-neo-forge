...
public class ModMountedStorageTypes {
    ...
    public static final RegistryEntry<StorageBoxMountedStorageType> STORAGE_BOX_MOUNTED = simpleItem("storagebox_mounted", StorageBoxMountedStorageType::new);
    public static final RegistryEntry<SimpleStorageBoxMountedStorageType> SIMPLE_STORAGE_BOX_MOUNTED = simpleItem("simple_storagebox_mounted", SimpleStorageBoxMountedStorageType::new);
