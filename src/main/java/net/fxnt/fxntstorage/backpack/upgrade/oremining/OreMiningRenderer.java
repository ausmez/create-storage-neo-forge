...
public class OreMiningRenderer {
    private static final int SOLID_R = 102;
    private static final int SOLID_G = 204;
    ...
    private static void writeEdges(VertexConsumer consumer, Matrix4f matrix,
        ...
        shape.forAllEdges((x1, y1, z1, x2, y2, z2) -> {
            ...
            consumer.vertex(matrix, (float) x1, (float) y1, (float) z1).color(r, g, b, a).normal(nx, ny, nz).endVertex();
            consumer.vertex(matrix, (float) x2, (float) y2, (float) z2).color(r, g, b, a).normal(nx, ny, nz).endVertex();
        });
    }
