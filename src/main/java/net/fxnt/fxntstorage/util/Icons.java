...
public class Icons extends AllIcons {
    ...
    public static final ResourceLocation ICON_ATLAS = FXNTStorage.modLoc("textures/gui/icons.png");
    ...
    public static final Icons
            I_ALLOW_EMPTY_FILL = newRow(),
            I_DENY_EMPTY_FILL = next(),
            I_INCLUDE_EMPTY = next(),
            I_EXCLUDE_EMPTY = newRow();
    ...
    private static Icons next() {
        return new Icons(++x, y);
    }

    private static Icons newRow() {
        return new Icons(x = 0, ++y);
    }
