...
public class BackpackNetworkHelper {
    public static final ResourceLocation BACKPACK_KEY_OPEN_CLOSE = new ResourceLocation(FXNTStorage.MOD_ID, "backpack_key_open_close");
    ...
    public static final ResourceLocation JETPACK_FLY = new ResourceLocation(FXNTStorage.MOD_ID, "jetpack_fly");
    public static final ResourceLocation PLAYER_INPUT = new ResourceLocation(FXNTStorage.MOD_ID, "player_input");
    public static final ResourceLocation SORT_BACKPACK_INVENTORY = new ResourceLocation(FXNTStorage.MOD_ID, "sort_backpack_inventory");
    public static final ResourceLocation SYNC_CLIENT_SETTINGS = new ResourceLocation(FXNTStorage.MOD_ID, "sync_client_settings");
    public static final ResourceLocation TOGGLE_HOVER = new ResourceLocation(FXNTStorage.MOD_ID, "toggle_jetpack_hover");
    public static final ResourceLocation UPGRADE_PICK_BLOCK = new ResourceLocation(FXNTStorage.MOD_ID, "upgrade_pick_block");

    public static final ResourceLocation SET_CARRIED = new ResourceLocation(FXNTStorage.MOD_ID, "upgrade_pick_block");
    public static final ResourceLocation SYNC_CONTAINER = new ResourceLocation(FXNTStorage.MOD_ID, "upgrade_pick_block");
    public static final ResourceLocation SYNC_SLOT_COUNT = new ResourceLocation(FXNTStorage.MOD_ID, "upgrade_pick_block");
    public static final ResourceLocation VISUAL_JETPACK_AIR = new ResourceLocation(FXNTStorage.MOD_ID, "upgrade_pick_block");
    ...
    public static void sortBackpack(int pSlotId, Util.InventorySortOrder pSortOrder) {
        ...
        if (pSlotId < Util.ITEM_SLOT_END_RANGE) {
            data.writeInt(Util.ITEM_SLOT_START_RANGE).writeInt(Util.ITEM_SLOT_END_RANGE).writeByte(sortOrder); // BackpackSlots
        } else if (pSlotId < Util.TOOL_SLOT_END_RANGE) {
            // TODO: Sort tools into tool slots followed by standard items?
            data.writeInt(Util.TOOL_SLOT_START_RANGE + 5).writeInt(Util.TOOL_SLOT_END_RANGE).writeByte(sortOrder); // ToolSlots
            ...
            data.writeInt(Util.UPGRADE_SLOT_END_RANGE).writeInt(Util.UPGRADE_SLOT_END_RANGE + 27).writeByte(sortOrder); // PlayerSlots
        } else {
            data.writeInt(Util.UPGRADE_SLOT_END_RANGE + 27).writeInt(Util.UPGRADE_SLOT_END_RANGE + 36).writeByte(sortOrder); // Hot bar
        }
